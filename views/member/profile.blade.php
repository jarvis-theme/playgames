...
<div class="row">
	...
	<div class="register-page">
			<div id="left_sidebar" class="col-md-3 col-xs-12">
	        ...
	        <div id="center_column" class="col-md-9 col-xs-9">
				{{Form::open(array('url'=>'member/update','method'=>'put','class'=>'form-horizontal'))}}
					<div class="form-group">
						<label for="inputName" class="col-md-2 control-label">Name</label>
						<div class="col-md-4">
							<input type="text" class="field-reg" id="inputName" name="nama" value='{{$user->nama}}' required placeholder="Name">
						</div>
					</div>            
					<div class="form-group">
						<label for="inputEmail1" class="col-md-2 control-label">Email</label>
						<div class="col-md-4">
							<input type="email" class="field-reg" name='email' value='{{$user->email}}' required id="inputEmail1" placeholder="Email">
						</div>
					</div>
					<div class="form-group">
						<label for="inputPhone" class="col-md-2 control-label">Telepon</label>
						<div class="col-md-4">
							<input type="text" class="field-reg" id="inputPhone" name='telp' value='{{$user->telp}}' required placeholder="Phone">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
						   <textarea class="field-reg" rows="3" placeholder="Address" name='alamat' required>{{$user->alamat}}</textarea>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="password" class="field-reg" name="password_confirmation" id="inputPassword" placeholder="Password">
						</div>
					</div>
					<hr />
					<div class="form-group">
