<div class="row">
    <div class="col-sm-12 p0">
        <div id="sign-up">
            ...
            <div class="account">
                <a href="{{url('member')}}">
                    <img src="{{url(dirTemaToko().'playgames/assets/img/login.png')}}" alt="My Account" title="My Account">
                </a>
            </div>
            <div class="login">
                <ul>
            ...
            @else
            <div class="account">
                <img src="{{url(dirTemaToko().'playgames/assets/img/login.png')}}" alt="My Account">
            </div>
            <div class="login">
                <ul>
        ...
        <ul id="menus-top-section">
            ...
            <li class="search">
                <button class="btn-form">
                    <img src="{{url(dirTemaToko().'playgames/assets/img/zoom.png')}}" alt="Search">
                </button>
            </li>
        </ul>
